export const loadingmessages = [
      ...
      "having a cheese fondue...",
      "wondering around...",
      "fingers crossed...",
      "sobering up...",
      "have a whiskey...",
      "waiting for Godot...",
      "blockchain mining firing off...",
      "have a look at genesis block...",
      "consensus finding in progress...",
      "going for a walk...",
      "Vitalik is verifying...",
      "KYC in progress (kidding)...",
      "playing Tetris...",
      "having a nap...",
      "having a cup of coffee...",
      "explaining why blockchain eats the world...",
      "disruption in place...",
      "check internet connectivity... ok...",
      "promoting the blockchain revolution...",
      "counting the blocks...",
      "a hash here, a hash there, hashing everywhere...",
      "learning French - et voilà!...",
      "learning German - Bitte schön...",
      "learning Swiss German - Chuchichäschtli...", 
      "exploring the crypto valley...",
      "mining... mining... mining......",
      "tweeting about a token rush...",
      "launching an ICO...",
      "by the way, who is Satoshi?",
      "Wanna know my private key? Sure! It's..."
    ];
